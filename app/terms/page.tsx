        ...
        <div className="bg-gradient-to-b from-blue-50 to-gray-50 min-h-screen py-8">
            <div className="max-w-3xl mx-auto px-6">
                ...
                <div className="space-y-6">
                    ...
                    <Card padding="md">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Materials on Website</h2>
                        <p className="text-gray-700 leading-relaxed">
                    ...
                    <Card padding="md">
                        ...
                        <p className="text-gray-700 mt-3">
                            📧 <a href="mailto:legal@mindfulplanner.com" className="text-blue-600 hover:underline">legal@mindfulplanner.com</a>
                        </p>
                    </Card>
                </div>
            </div>
